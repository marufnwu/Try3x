...
public class PackagesListAdapter extends RecyclerView.Adapter<PackagesListAdapter.MyViewHolder> {
    ...
    public PackagesListAdapter(Context ctx, List<Packages> packageList, int btnId, OnPackageItemClickListener onPackageItemClickListener) {
        this.ctx = ctx;
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new MyViewHolder(LayoutInflater.from(ctx).inflate(R.layout.layout_pck_item, parent, false));
    }
